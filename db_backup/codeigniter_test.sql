...
--
-- Anamakine: localhost
-- Üretim Zamanı: 24 Oca 2013, 16:33:11
...
(1, 'hakkimizda ornek metni', 'vizyonumuz ornek metni', 'misyonumuz ornek metni');
...
(1, 'sample address_2', 'sample phone_2', 'sample fax_2', 'sample email_2', 'sample facebook_2', 'sample twitter_2', 'sample gplus_2');
