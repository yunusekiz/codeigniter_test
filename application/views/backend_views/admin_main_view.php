		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a href="#" class="current">Galeriye Resim Ekle</a></li>
						<li><a href="#" class="">Galeriyi Düzenle</a></li> <!-- Add class "current" to sub menu items also -->
				...
				<li> 
					...
					<ul>
						<li><a href="#" class="'.$referans_ekle.'">Referans Ekle</a></li>
				...
				<li>
					...
					<ul>
						<li><a href="#" class="">Yeni Belge Ekle</a></li>
						<li><a href="#" class="">Belgeleri Düzenle</a></li>						
					</ul>
